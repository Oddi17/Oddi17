...
*** 
В настоящее время являюсь Data Engineer в Glowbyte Consulting (сентябрь, 2025 - настоящее время)
- Разрабатывал и настраивал ETL-процессы для репликации витрин данных из PostgreSQL/Greenplum (PXF)
в ClickHouse через S3 с использованием оркестратора Airflow в рамках КХД/ЦЕХ одного из крупнейших
банков для построения OLAP-кубов и дашбордов
- Настраивал ETL-процессы очистки и актуализации данных в OLAP-кубах, используя инструмент Форсайт
BI
- Настраивал табличные структуры в кластере ClickHouse: ReplacingMergeTree (актуальный срез), S3Queue
(приём данных из S3), Distributed (распределённые таблицы). Обеспечивал согласованность схем данных и
типов между системами
- Написание и рефакторинг SQL-скриптов в соответствии со стандартами проекта
- Участвовал в функциональном и интеграционном тестировании результатов разработки
- Опыт командной разработки с использованием GIT

***
__Industrial Control Systems (ICS) Software Engineer <br />
(Инженер-программист АСУ ТП) (сентябрь, 2023 - )__
...
***
__Веб-разработчик (февраль, 2023 - )__ <br />
